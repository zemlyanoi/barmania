...
'	<tr><td colspan="2" class="headtext">Вам уже исполнилось 18 лет?<BR/><BR/></td></tr>' +
'	<tr>' +
'		<td id="lp"><input type="button" value="Нет" onclick="agejs(\'<18\');" /></td>' +
'		<td id="rp"><input type="button" value="Да" onclick="agejs(\'>18\');" /></td>' +
'	</tr>' +
'</table>';
